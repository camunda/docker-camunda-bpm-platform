...
- `tomcat-7.8.0-alpha3`, `7.8.0-alpha3`, `tomcat-latest`, `tomcat`, `latest` ([Dockerfile][dockerfile-tomcat-780-alpha3])
...
- `jboss-7.8.0-alpha3`, `jboss-latest`, `jboss` ([Dockerfile][dockerfile-jboss-780-alpha3])
...
- `wildfly-7.8.0-alpha3`, `wildfly-latest`, `wildfly` ([Dockerfile][dockerfile-wildfly-780-alpha3])
...
[dockerfile-tomcat-780-alpha3]: https://github.com/camunda/docker-camunda-bpm-platform/blob/master/Dockerfile
...
[status-tomcat-780-alpha3]: https://travis-ci.org/camunda/docker-camunda-bpm-platform.svg?branch=master
