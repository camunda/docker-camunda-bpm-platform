...
- `tomcat-7.7.0`, `7.7.0`, `tomcat-latest`, `tomcat`, `latest` ([Dockerfile][dockerfile-tomcat-770])
...
- `jboss-7.7.0`, `jboss-latest`, `jboss` ([Dockerfile][dockerfile-jboss-770])
...
- `wildfly-7.7.0`, `wildfly-latest`, `wildfly` ([Dockerfile][dockerfile-wildfly-770])
...
[dockerfile-tomcat-770]: https://github.com/camunda/docker-camunda-bpm-platform/blob/master/Dockerfile
...
[status-tomcat-770]: https://travis-ci.org/camunda/docker-camunda-bpm-platform.svg?branch=master
