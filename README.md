...
- `tomcat-7.4.0-alpha2`, `tomcat-latest`, `7.4.0-alpha2`, `latest` ([Dockerfile][dockerfile-tomcat-740-alpha2])
...
- `jboss-7.4.0-alpha2`, `jboss-latest` ([Dockerfile][dockerfile-jboss-740-alpha2])
