...
| 7.7.0-alpha2 | [![Tomcat 7.7.0-alpha2][status-tomcat-770-alpha2]][travis] | [![JBoss 7.7.0-alpha2][status-jboss-770-alpha2]][travis] | [![WildFly 7.7.0-alpha2][status-wildfly-770-alpha2]][travis] |
| 7.7.0-alpha1 | [![Tomcat 7.7.0-alpha1][status-tomcat-770-alpha1]][travis] | [![JBoss 7.7.0-alpha1][status-jboss-770-alpha1]][travis] | [![WildFly 7.7.0-alpha1][status-wildfly-770-alpha1]][travis] |
...
- `tomcat-7.8.0-alpha2`, `7.8.0-alpha2`, `tomcat-latest`, `tomcat`, `latest` ([Dockerfile][dockerfile-tomcat-780-alpha2])
...
- `tomcat-7.7.0-alpha2`, `7.7.0-alpha2` ([Dockerfile][dockerfile-tomcat-770-alpha2])
- `tomcat-7.7.0-alpha1`, `7.7.0-alpha1` ([Dockerfile][dockerfile-tomcat-770-alpha1])
...
- `jboss-7.8.0-alpha2`, `jboss-latest`, `jboss` ([Dockerfile][dockerfile-jboss-780-alpha2])
- `jboss-7.8.0-alpha1` ([Dockerfile][dockerfile-jboss-780-alpha1])
- `jboss-7.7.0` ([Dockerfile][dockerfile-jboss-770])
- `jboss-7.7.0-alpha2` ([Dockerfile][dockerfile-jboss-770-alpha2])
- `jboss-7.7.0-alpha1` ([Dockerfile][dockerfile-jboss-770-alpha1])
...
- `wildfly-7.8.0-alpha2`, `wildfly-latest`, `wildfly` ([Dockerfile][dockerfile-wildfly-780-alpha2])
- `wildfly-7.8.0-alpha1` ([Dockerfile][dockerfile-wildfly-780-alpha1])
- `wildfly-7.7.0` ([Dockerfile][dockerfile-wildfly-770])
- `wildfly-7.7.0-alpha2` ([Dockerfile][dockerfile-wildfly-770-alpha2])
- `wildfly-7.7.0-alpha1` ([Dockerfile][dockerfile-wildfly-770-alpha1])
...
[dockerfile-tomcat-770-alpha1]: https://github.com/camunda/docker-camunda-bpm-platform/blob/tomcat-7.7.0-alpha1/Dockerfile
[dockerfile-jboss-770-alpha1]: https://github.com/camunda/docker-camunda-bpm-platform/blob/jboss-7.7.0-alpha1/Dockerfile
[dockerfile-wildfly-770-alpha1]: https://github.com/camunda/docker-camunda-bpm-platform/blob/wildfly-7.7.0-alpha1/Dockerfile
[dockerfile-tomcat-770-alpha2]: https://github.com/camunda/docker-camunda-bpm-platform/blob/tomcat-7.7.0-alpha2/Dockerfile
[dockerfile-jboss-770-alpha2]: https://github.com/camunda/docker-camunda-bpm-platform/blob/jboss-7.7.0-alpha2/Dockerfile
[dockerfile-wildfly-770-alpha2]: https://github.com/camunda/docker-camunda-bpm-platform/blob/wildfly-7.7.0-alpha2/Dockerfile
...
[dockerfile-tomcat-780-alpha2]: https://github.com/camunda/docker-camunda-bpm-platform/blob/master/Dockerfile
...
[status-tomcat-770-alpha1]: https://travis-ci.org/camunda/docker-camunda-bpm-platform.svg?branch=tomcat-7.7.0-alpha1
[status-jboss-770-alpha1]: https://travis-ci.org/camunda/docker-camunda-bpm-platform.svg?branch=jboss-7.7.0-alpha1
[status-wildfly-770-alpha1]: https://travis-ci.org/camunda/docker-camunda-bpm-platform.svg?branch=wildfly-7.7.0-alpha1
[status-tomcat-770-alpha2]: https://travis-ci.org/camunda/docker-camunda-bpm-platform.svg?branch=tomcat-7.7.0-alpha2
[status-jboss-770-alpha2]: https://travis-ci.org/camunda/docker-camunda-bpm-platform.svg?branch=jboss-7.7.0-alpha2
[status-wildfly-770-alpha2]: https://travis-ci.org/camunda/docker-camunda-bpm-platform.svg?branch=wildfly-7.7.0-alpha2
...
[status-tomcat-780-alpha2]: https://travis-ci.org/camunda/docker-camunda-bpm-platform.svg?branch=master
