...
- `tomcat-7.8.0-SNAPSHOT`, `tomcat-SNAPSHOT`, `7.8.0-SNAPSHOT`, `SNAPSHOT` ([Dockerfile][dockerfile-tomcat-snapshot])
- `tomcat-7.8.0-alpha6`, `7.8.0-alpha6`, `tomcat-latest`, `tomcat`, `latest` ([Dockerfile][dockerfile-tomcat-780-alpha6])
...
- `jboss-7.8.0-SNAPSHOT`, `jboss-SNAPSHOT` ([Dockerfile][dockerfile-jboss-snapshot])
- `jboss-7.8.0-alpha6`, `jboss-latest`, `jboss` ([Dockerfile][dockerfile-jboss-780-alpha6])
...
- `wildfly-7.8.0-SNAPSHOT` `wildfly-SNAPSHOT` ([Dockerfile][dockerfile-wildfly-snapshot])
- `wildfly-7.8.0-alpha6`, `wildfly-latest`, `wildfly` ([Dockerfile][dockerfile-wildfly-780-alpha6])
...
[dockerfile-tomcat-780-alpha6]: https://github.com/camunda/docker-camunda-bpm-platform/blob/master/Dockerfile
...
[status-tomcat-780-alpha6]: https://travis-ci.org/camunda/docker-camunda-bpm-platform.svg?branch=master
